...
def translate_pdf(file_path, lang_code:str="zh-Hant", text_engine: str = "gpt-3.5-turbo", num_workers:int=10):
...
def app(args):
    ...
    translate_pdf(file_path, lang_code, text_engine, num_workers)
